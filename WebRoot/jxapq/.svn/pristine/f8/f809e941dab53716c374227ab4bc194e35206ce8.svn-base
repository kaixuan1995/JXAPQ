...
<body>
	<div id="container">
		<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center"  border="0">
			<tr>
		      <th colspan="2">网站介绍</th>
		    </tr>
		    <tr>
		      <td width="100" height="30">建站宗旨<span class="TableRow2"></span></td>
		      <td style="text-align:left">该网站为江西省动植物信息检索系统，为教务项目，旨在为江西省建立一个完善的动植物信息数据库，方便科研以及教学。</td>
		    </tr>
			<tr>
		      <th colspan="2">联系方式</th>
		    </tr>
		    <tr>
		      <td width="100" height="30">邮箱<span class="TableRow2"></span></td>
			  <td style="text-align:left">
		      	<a href="mailto:shangcent@126.com">jiangxidongzhiwu@163.com</a>
		      </td>
		...
		<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
		    ...
		    <tr>
		      ...
		      <td style="text-align:left">江西农业大学蓝点工作室</td>
		    </tr>
		    <tr>
		      <td width="100" height="30">联系方式</td>
		      <td style="text-align:left">
		      	<a href="mailto:shangcent@126.com">bluedot_2013@126.com</a>
		      </td>
		    </tr>
		    <tr>
		      <td width="100" height="30">程序主页<span class="TableRow2"></span></td>
		      <td style="text-align:left">
		      	<a href="*" target="_blank">http://www.xxxx.com</a>
		      </td>
		    </tr>
		</table>
	</div>
