...
<div id="container">
  ...
  <p>
  <div id="box_top">新增纲 <a href="${pageContext.request.contextPath}/QueryServlet?method=linkage&view=Linkage&forward=importGang&sign=false">导入纲模板</a></div>
  </p>
  <div class="ui_content">
    <form id="submitForm" name="submitForm"onsubmit="return getConf()" action="${pageContext.request.contextPath}/UpdateServlet?method=add&view=addGangView" method="post">
      <table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
        ...
        <tr>
          ...
          <td class="ui_text_lt"><input type="text" id="sname" name="class_sname =" value="Aves" class="ui_input_txt02"/>
           <input type="text" hidden="hidden" id="flag" name="flag =" value="0" class="ui_input_txt02"/>
           <label id="snameError"></label>
          </td>
        </tr>
        <tr>
          <td class="ui_text_rt" width="80">中文名：</td>
          <td class="ui_text_lt"><input type="text" id="cname" name="class_cname =" value="鸟纲" class="ui_input_txt02"/>
        ...
        <tr>
          ...
          <td class="ui_text_lt"><input type="text" id="spelling" name="class_spelling ="  value="NIAOGANG" class="ui_input_txt02" onKeyUp="checkFyFh();"/>
        ...
        <tr>
          ...
          <td class="ui_text_lt">&nbsp;
            <textarea name="class_summarize =" class="ui_tb_h30" id="summarize" style="width: 483px; height: 153px;"></textarea>
