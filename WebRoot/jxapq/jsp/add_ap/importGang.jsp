...
<style type="text/css">
  ...
  <div id="box_top">批量导入纲
  <input type="button"  value="下载模板" class="ui_input_btn01" onclick='downloadTemplate("纲模板.xls")'/> &nbsp;
  </div>
  <div class="ui_content">
    ...
    <input type='hidden' name="voName" value="addGangView" />
    	...
    	<tr>
		 <td class="ui_text_rt">所属分类：</td>
		  ...
		  <select name="kingdom_3id =" id="kingdom" class="ui_select01">
            ...
            <select name="foreign_key_value" id="phylum" class="ui_select01">
              	<option selected="selected">请选择所属门</option>
            </select>
          </td>
        </tr>  
		<tr>
          <td height="37" class="ui_text_rt" >纲文件：</td>
          <td class="ui_text_lt"  ><input type="file"  name="file"  value=""   onKeyUp="checkFyFh();"/></td>
        </tr>
		   <tr>
          <td height="40">&nbsp;</td>
          <td class="ui_text_lt">
