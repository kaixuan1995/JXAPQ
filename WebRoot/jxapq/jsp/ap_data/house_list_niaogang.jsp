			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">目
							  <input type="text" id="mu" name="mutext" class="mutext" />
							科
							<input type="text" id="shu" name="shutext" class="shutext" />
							属
							<input type="text" id="zhong" name="zhongtext" class="zhongtext" />
							种
