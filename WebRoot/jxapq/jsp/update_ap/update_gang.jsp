...
<div id="container">
  <div id="nav_links"> 当前位置：动植物数据管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">修改纲资料</span>
  ...
  <div id="box_top">修改纲资料</div>
  <div class="ui_content">
    <form id="submitForm" onsubmit="return getConf()" name="submitForm" action="${pageContext.request.contextPath }/UpdateServlet?method=update&view=updateGangView" method="post">
      <table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
        <tr>
          <td class="ui_text_rt">学名：</td>
          <td class="ui_text_lt">
          <input type="text" id="sname" name="#s#class_sname =" value="${list.get(0).class_sname }" class="ui_input_txt02"/>
          <input type="text" hidden="" name="#w#class_id =" value="${list.get(0).class_id }" class="ui_input_txt02"/>
          <label id="snameError"></label>
          </td>
        </tr>
        <tr>
          <td class="ui_text_rt" width="80">中文名：</td>
          <td class="ui_text_lt"><input type="text" id="cname" name="#s#class_cname =" value="${list.get(0).class_cname }" class="ui_input_txt02"/>
          <label id="cnameError"></label>
          </td>
        </tr>
        <tr>
          <td class="ui_text_rt">英文名：</td>
          <td class="ui_text_lt"><input type="text" id="ename" name="#s#class_ename =" value="${list.get(0).class_ename }" class="ui_input_txt02"/>
          <label id="enameError"></label>
          </td>
        </tr>
        <tr>
          <td class="ui_text_rt">中文拼音：</td>
          <td class="ui_text_lt"><input type="text" id="spelling"name="#s#class_spelling =" value="${list.get(0).class_spelling }" class="ui_input_txt02"/>
        ...
        <tr>
          ...
          <td class="ui_text_lt">&nbsp;
            <textarea class="ui_tb_h30" id="summarize" style="width: 483px; height: 153px;" name="#s#class_summarize =">${list.get(0).class_summarize }</textarea>
