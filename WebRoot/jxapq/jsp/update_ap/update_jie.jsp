...
<body>
	...
	<div id="container">
		<div id="nav_links">
			当前位置：动植物信息管理&nbsp;&nbsp;<span style="color: #1A5CC6;">修改界资料</span>
			<div id="page_close">
		...
		<p><div id="box_top">修改界资料</div>
		<div class="ui_content">
		<form id="submitForm" name="submitForm" action="${pageContext.request.contextPath }/UpdateServlet?method=update&view=updateJieView" method="post">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					<td class="ui_text_rt">学名：</td>
					<td class="ui_text_lt">
						<input type="text" name="#s#kingdom_sname =" value="${list.get(0).kingdom_sname }" class="ui_input_txt02"/>
						<input type="text" hidden="" name="#w#kingdom_id =" value="${list.get(0).kingdom_id }" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt" width="80">中文名：</td>
					<td class="ui_text_lt">
						<input type="text" name="#s#kingdom_cname =" value="${list.get(0).kingdom_cname }" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">英文名：</td>
					<td class="ui_text_lt">
						<input type="text" name="#s#kingdom_ename =" value="${list.get(0).kingdom_ename }" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">中文拼音：</td>
					<td class="ui_text_lt">
						<input type="text" name="#s#kingdom_spelling =" value="${list.get(0).kingdom_spelling }" class="ui_input_txt02"/></td>
				</tr>
				<tr>
					<td class="ui_text_rt">概述：</td>
					<td class="ui_text_lt">&nbsp;<textarea name="#s#kingdom_summarize =" class="ui_tb_h30" style="width: 483px; height: 153px;">${list.get(0).kingdom_summarize }</textarea>    </td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td class="ui_text_lt">
