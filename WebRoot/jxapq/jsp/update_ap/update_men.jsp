...
<body>
	...
	<div id="container">
		<div id="nav_links">
			当前位置：动植物数据管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">修改门资料</span>
			<div id="page_close">
		...
		<p><div id="box_top">修改门资料</div>
		<div class="ui_content">
		<form id="submitForm" name="submitForm" onsubmit="return getConf()" action="${pageContext.request.contextPath }/UpdateServlet?method=update&view=updateMenView" method="post">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					<td class="ui_text_rt">学名：</td>
					<td class="ui_text_lt">
						<input type="text" id="sname" name="#s#phylum_sname =" value="${list.get(0).phylum_sname }" class="ui_input_txt02"/>
						<input type="text" hidden="" name="#w#phylum_id =" value="${list.get(0).phylum_id }" class="ui_input_txt02"/>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="cname" name="#s#phylum_cname =" value="${list.get(0).phylum_cname }" class="ui_input_txt02"/>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="ename" name="#s#phylum_ename =" value="${list.get(0).phylum_ename }" class="ui_input_txt02"/>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="spelling" name="#s#phylum_spelling =" value="${list.get(0).phylum_spelling }" class="ui_input_txt02"/>
					<label id="spellingError"></label>	
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">概述：</td>
					<td class="ui_text_lt">&nbsp;<textarea id="summarize" name="#s#phylum_summarize =" class="ui_tb_h30" style="width: 483px; height: 153px;">${list.get(0).phylum_summarize }</textarea>
