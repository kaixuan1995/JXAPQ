...
$.idealforms.errors = {
  ...
  yxyzm: '必须6位数字. <em>(e.g. 123456)</em>',
  yzm: '必须4位数字. <em>(e.g. 1234)</em>',
   
  phone: '必须是符合格式的电话号码. <em>(e.g.18712345678)</em>',
...
var getFilters = function() {
  ...
  var filters = {
	...
	yxyzm: {
      regex: /^\d{6}$/,
      error: $.idealforms.errors.yxyzm
    },
	yzm: {
      regex: /^\d{4}$/,
      error: $.idealforms.errors.yzm
    },
    phone: {
      regex: /^[1][358][0-9]{9}$/,
    ...
    date: {
      regex: function( input, value ) {
        ...
        theFormat = userFormat.split(delimiter), //yyyy  dd  mm
        theDate = value.split(delimiter), //2015   08  22
